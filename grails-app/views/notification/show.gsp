            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="notification.initiator.label" default="Initiator" /></td>
                            
                            <td valign="top" class="value"><g:link controller="player" action="show" id="${notificationInstance?.initiator?.id}">${notificationInstance?.initiator?.encodeAsHTML()}</g:link></td>
