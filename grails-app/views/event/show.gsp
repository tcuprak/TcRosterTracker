            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="event.host.label" default="Host" /></td>
                            
                            <td valign="top" class="value"><g:link controller="player" action="show" id="${eventInstance?.host?.id}">${eventInstance?.host?.encodeAsHTML()}</g:link></td>
