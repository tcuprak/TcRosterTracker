...
<%@ page import="rostertracker.Team" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="messages"><g:message code="team.messages.label" default="Messages" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: teamInstance, field: 'messages', 'errors')}">
                                    <g:select name="messages" from="${rostertracker.Notification.list()}" multiple="yes" optionKey="id" size="5" value="${teamInstance?.messages*.id}" />
                                </td>
                            </tr>
